...
public class Nueva_contrasena extends javax.swing.JFrame {
  ...
  public Nueva_contrasena() {
    ...
    private void initComponents() {
        ...
        jPanel9.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 100, 330, 40));
        ...
        jPanel9.add(txtNuevaContrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, 480, 40));
        ...
        rSButtonPane1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 260, 20));
        ...
        jLabel13.setText("Usar almenos un numero");
        ...
        rSButtonPane1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 260, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Nueva_contrasena.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Nueva_contrasena().setVisible(true);
            }
        });
    }
